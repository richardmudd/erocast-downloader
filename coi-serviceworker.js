...
if (typeof window === "undefined") {
    ...
    (() => {
        ...
        if (!window.isSecureContext) { if (!coi.quiet) console.log("COOP/COEP Service Worker not registered, a secure context is required."); return; }
        if (!n.serviceWorker) { if (!coi.quiet) console.error("COOP/COEP Service Worker not registered, perhaps due to private mode."); return; }
